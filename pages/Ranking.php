<h1><center>E Sport Rankings</center></h1>
...
//include guild class
require_once('/r/guild.class.php');
...
echo '<table border=0 cellspacing=5 cellpadding=1>
		<tr>
			<font color="#FFE4E1"><th><font color="#FFE4E1">Rank</th>
			<th><font color="#FFE4E1">Name</th>
			<th><font color="#FFE4E1">Job</th>
			<th><font color="#FFE4E1">Level</th>
			<th><font color="#FFE4E1">Faction</th>
			<th><font color="#FFE4E1">Guild</th>
			<th><font color="#FFE4E1">Status</th>
			<th><font color="#FFE4E1">Map</th>
			<th><font color="#FFE4E1">Kills</th>
			<th><font color="#FFE4E1">Death</th>
			<th><font color="#FFE4E1">KDR</th>
			<th><font color="#FFE4E1">Icon</th></font>
		</tr>';
...
for ($i = 1; $char = odbc_fetch_array($res); $i++){
	if ($i >= $begin) {
		...
		if ($char['K2'] == 0)
			...
			$kdr = '<font color="# 	00FFFF">UKN</font>';
			$char['K2'] = '<font color="#7B68EE">UKN</font>';
