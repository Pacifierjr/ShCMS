...
if (isset($_POST['SC'])) {
	...
	VALUES 
	(\''.$Log['UserID'].'\',\''.$ip.'\',\'' . $UserID . '\',\'UnJail All of '.$UserID.' Toons.\',GETDATE())');
	...
	while ($Row = @mssql_fetch_assoc($query)) {
		$Chars2 = mssql_query("UPDATE PS_GameData.dbo.Chars SET Map = 42,PosX = 55,PosY = 3 ,PosZ = 54 where CharID = " . $Row['CharID'] . "");
		echo '</form>';
	}
} else {
?>
...
<html>
<head>
<title>Un Jail Toons</title>
</head>
<body>
<font face="Trebuchet MS">
<center>
<br><br>
<b>Releace Jailed toons for this account by /kicking online toon then submit the toon name here<br>
<form action="<?php
