...
class invAction{
	...
	public function execute(){
		if (isset($_GET['uid'])){
			...
			echo '<tr><td>Charakter: </td><td><a href="index.php?action=char&amp;CharID='.$this->char->getCharID().'">'.$this->char->getName().'</a></td><td></td></tr>';
			...
			echo '<tr><td>Qualite: </td><td>'.Parser::Zahl($this->item->getQuality()).'</td><td><a href="javascript::void();" id="halt">changer qualite</a></td></tr>';
			echo '<tr><td>Max. Qualite: </td><td>'.Parser::Zahl($this->item->getMaxQuality()).'</td><td></td></tr>';
			echo '<tr><td>Rucksack: </td><td>'.$this->infoArr['Bag'].'</td><td></td></tr>';
			...
			$(function(){
				...
				$("#unlink1dia").dialog({
					...
					buttons: {
						Ja: function() {
							document.location.href = 'index.php?action=inv&uid=<?php echo $this->item->getUID();?>&do=unlinklapis&slot=1';
							$(this).dialog('close');
						},
				...
				$("#unlink2dia").dialog({
					...
					buttons: {
						Ja: function() {
							document.location.href = 'index.php?action=inv&uid=<?php echo $this->item->getUID();?>&do=unlinklapis&slot=2';
							$(this).dialog('close');
						},
				...
				$("#unlink3dia").dialog({
					...
					buttons: {
						Ja: function() {
							document.location.href = 'index.php?action=inv&uid=<?php echo $this->item->getUID();?>&do=unlinklapis&slot=3';
							$(this).dialog('close');
						},
				...
				$("#unlink4dia").dialog({
					...
					buttons: {
						Ja: function() {
							document.location.href = 'index.php?action=inv&uid=<?php echo $this->item->getUID();?>&do=unlinklapis&slot=4';
							$(this).dialog('close');
						},
				...
				$("#unlink5dia").dialog({
					...
					buttons: {
						Ja: function() {
							document.location.href = 'index.php?action=inv&uid=<?php echo $this->item->getUID();?>&do=unlinklapis&slot=5';
							$(this).dialog('close');
						},
				...
				$("#unlink6dia").dialog({
					...
					buttons: {
						Ja: function() {
							document.location.href = 'index.php?action=inv&uid=<?php echo $this->item->getUID();?>&do=unlinklapis&slot=6';
							$(this).dialog('close');
						},
				...
				$("#deldia").dialog({
					...
					buttons: {
						Ja: function() {
							document.location.href = 'index.php?action=inv&uid=<?php echo $this->item->getUID();?>&do=delete';
							$(this).dialog('close');
						},
