		...
		if (isset($_GET['uid'])){
				...
				switch($_GET['do']){
					case 'halt':
						if (isset($_POST['halt'])){
							...
							if ($this->error == 1)
								echo '<div class="success">La durabilité de l objet '.$this->item->getItemName().' a été modifiée avec succès.</div>';
							else
					...
					case 'craft':
						if (isset($_POST['stat'])){
							...
							if ($this->error == 1)
								echo '<div class="success">EP-4 Stats des Items '.$this->item->getItemName().' changé avec succès.</div>';
							else
								echo '<div class="error">'.$this->error.'</div>';
						}
						else
					...
					case 'unlinklapis':
						...
						if ($this->error == 1)
							echo '<div class="success">Lapis (Slot: '.$_GET['slot'].') avec succès à partir de la pièce '.$this->item->getItemName().' de.</div>';
						else
							echo '<div class="error">'.$this->error.'</div>';
						break;
					case 'linklapis':
						if (isset($_POST['lapis'])){
							...
							if ($this->error == 1)
								echo '<div class="success">Lapis succès dans le Item '.$this->item->getItemName().' socket.</div>';
							else
								echo '<div class="error">'.$this->error.'</div>';
						}
						else
			...
			$(function(){
				...
				$("#unlink1dia").dialog({
					...
					buttons: {
						Ja: function() {
							document.location.href = 'index.php?action=ai&uid=<?php echo $this->item->getUID();?>&do=unlinklapis&slot=1';
							$(this).dialog('close');
						},
				...
				$("#unlink2dia").dialog({
					...
					buttons: {
						Ja: function() {
							document.location.href = 'index.php?action=ai&uid=<?php echo $this->item->getUID();?>&do=unlinklapis&slot=2';
							$(this).dialog('close');
						},
				...
				$("#unlink3dia").dialog({
					...
					buttons: {
						Ja: function() {
							document.location.href = 'index.php?action=ai&uid=<?php echo $this->item->getUID();?>&do=unlinklapis&slot=3';
							$(this).dialog('close');
						},
				...
				$("#unlink4dia").dialog({
					...
					buttons: {
						Ja: function() {
							document.location.href = 'index.php?action=ai&uid=<?php echo $this->item->getUID();?>&do=unlinklapis&slot=4';
							$(this).dialog('close');
						},
				...
				$("#unlink5dia").dialog({
					...
					buttons: {
						Ja: function() {
							document.location.href = 'index.php?action=ai&uid=<?php echo $this->item->getUID();?>&do=unlinklapis&slot=5';
							$(this).dialog('close');
						},
				...
				$("#unlink6dia").dialog({
					...
					buttons: {
						Ja: function() {
							document.location.href = 'index.php?action=ai&uid=<?php echo $this->item->getUID();?>&do=unlinklapis&slot=6';
							$(this).dialog('close');
						},
			...
			<div id="lapisadia" title="Verzauberung ändern">Wie soll die neue Verzauberung des Items '<?php echo $this->item->getItemName();?>' (Account: <?php echo $this->user->getName();?>, ItemUID: <?php echo $this->item->getUID();?>) lauten?<form action="index.php?action=ai&amp;uid=<?php echo $this->item->getUID();?>&amp;do=craft&amp;stat=Lapisa" method="POST"><br><input type="text" name="stat" maxlength=2 size=4><br>0-20 bei Waffen<br>50-70 bei Rüstungen</form></div>
