...
echo "<center>";
echo "<br /><font size=5 face=comic ms color=Blue><b><i> Elements story <br /></font>";
...
<table border=0 style='table-layout:fixed' cellpadding=2 cellspacing=1><col width=100>
                <tr>
                <tr>
                    <td WIDTH=150 BGCOLOR=#FF4500><b><font size=2 face=arial color=white><b>Date et heure</td>
...
$result = mssql_query("SELECT TOP 5000  CharID, ChatType, TargetName, ChatData, ChatTime, MapID FROM [PS_ChatLog].[dbo].[ChatLog] ORDER BY row DESC ", $link);
