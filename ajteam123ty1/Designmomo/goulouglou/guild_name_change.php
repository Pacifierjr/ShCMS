...
elseif (isset($_POST['CNE'])) {
	mssql_query('UPDATE PS_GameData.dbo.Guilds SET GuildID = \'' . $_POST['GuildID'] . '\',GuildName = \'' . $_POST['GuildName'] . '\', MasterUserID = \'' . $_POST['MasterUserID'] . '\', MasterCharID = \'' . $_POST['MasterCharID'] . '\', MasterName = \'' . $_POST['MasterName'] . '\', Country = \'' . $_POST['Country'] . '\', TotalCount = \'' . $_POST['TotalCount'] . '\', GuildPoint = \'' . $_POST['GuildPoint'] . '\', Del = \'' . $_POST['Del'] . '\', CreateDate = \'' . $_POST['CreateDate'] . '\',DeleteDate = \'' . $_POST['DeleteDate'] . '\' WHERE GuildID=\'' . $_POST['GuildID'] . '\'');
	...
	VALUES 
	(\''.$Log['UserID'].'\',\''.$ip.'\',\''. $_POST['CharName'] .'\',\'Change Guild Name. \',GETDATE())');
...
<html>
<head>
<title>Change Guild Name</title>
</head>
<body>
<font face="Trebuchet MS">
<center>
<br><br>
<b>Change Guild Name<br>
<form action="<?php
