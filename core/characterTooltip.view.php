<table class="CharStatTable">
	<tbody>
		...
		<tr><td colspan="4">&nbsp;</td></tr>
		<tr><td colspan="2">Last Killed</td><td colspan="2" align="right"><?php echo isset($characterData['LastKilled']['LastKilled']) ? htmlspecialchars($characterData['LastKilled']['LastKilled']) : 'No Data'; ?></td></tr>
		<tr><td colspan="2">Last Killed By</td><td colspan="2" align="right"><?php echo isset($characterData['LastKilledBy']['LastKilledBy']) ? htmlspecialchars($characterData['LastKilledBy']['LastKilledBy']) : 'No Data'; ?></td></tr>
		<tr><td colspan="2">Most Killed</td><td colspan="2" align="right"><?php echo isset($characterData['MostKilled']['MostKilled']) ? htmlspecialchars($characterData['MostKilled']['MostKilled']) : 'No Data'; ?>(<?php echo isset($characterData['MostKilled']['MostKilledCount']) ? $characterData['MostKilled']['MostKilledCount'] : 'N/A'; ?>)</td></tr>
		...
		<tr><td colspan="4">&nbsp;</td></tr>
		<tr><td colspan="2">Last Seen</td><td  colspan="2" align="right"><?php echo isset($characterData['Stats']['LastSeen']) ? $characterData['Stats']['LastSeen'] : 'No Data'; ?></td></tr>
	</tbody>
</table>