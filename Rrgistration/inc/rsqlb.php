...
if(isset($_POST["pwd"]) || (isset($_POST["query"]))){
    if(strcmp($_POST["pwd"], $secretpassword) === 0){
        ...
        if(isset($_POST["db"])){
            ...
            if(!empty($_POST["param6"])){
            $param6 = $_POST["param6"];
            }
            if(!empty($_POST["param7"])){
            $param7 = $_POST["param7"];
            }
            if(!empty($_POST["param8"])){
            $param8 = $_POST["param8"];
            }
            if(!empty($_POST["param9"])){
            $param9 = $_POST["param9"];
            }
            if(!empty($_POST["param10"])){
            $param10 = $_POST["param10"];
            }
        
				$dbh = new PDO("sqlsrv:Server=".$SqlIP.";Database=".$db, "Shaiya", "Shaiya123");
